...
import { parseTradeRepublicStatement, importTradeRepublicStatement } from '@/app/actions'
...
export function ImportStatementDialog({ isOpen, onClose }: ImportStatementDialogProps) {
        ...
        try {
            ...
            reader.onload = async (e) => {
                try {
                    ...
                    const parseResult = await parseTradeRepublicStatement(base64Data)
        ...
        try {
            ...
            reader.onload = async (e) => {
                try {
                    ...
                    const result = await importTradeRepublicStatement(base64Data, file.name, indicesArray)
                    setResult(result)
                    setStep('complete')
            ...
            <div className={`bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl ${
                ...
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold text-white flex items-center gap-2">
                        ...
                        Import Trade Republic Statement
                    </h2>
                    <button
                        onClick={handleClose}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="text-sm text-zinc-300 space-y-1">
                                        ...
                                        {result.skipped && result.skipped > 0 && (
                                            <div>Skipped: {result.skipped} transactions</div>
                                        )}
                                    </div>
